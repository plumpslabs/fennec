...
describe('Planner', () => {
  ...
  describe('getPlan and listPlans', () => {
    ...
    it('should list all plans', () => {
      planner.createPlan('Plan A', [
        { description: 'Step 1', tool: 't1', input: {}, dependsOn: [], timeoutMs: 1000 },
      ]);
      planner.createPlan('Plan B', [
        { description: 'Step 1', tool: 't2', input: {}, dependsOn: [], timeoutMs: 1000 },
      ]);

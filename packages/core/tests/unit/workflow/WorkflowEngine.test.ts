...
describe("WorkflowEngine", () => {
  ...
  describe("get and list", () => {
    it("should get a workflow by ID", () => {
      const wf = engine.register({
        name: "Test", description: "Test workflow", version: "1.0.0", tags: [], steps: [],
      });
  ...
  describe("findByTag", () => {
    it("should find workflows by tag", () => {
      engine.register({ name: "Debug", description: "", version: "1.0.0", tags: ["diagnostic", "built-in"], steps: [] });
      engine.register({ name: "Other", description: "", version: "1.0.0", tags: ["other"], steps: [] });
  ...
  describe("remove", () => {
    it("should remove a workflow", () => {
      const wf = engine.register({
        name: "Test", description: "", version: "1.0.0", tags: [], steps: [],
      });
  ...
  describe("execute", () => {
    it("should execute a workflow successfully", async () => {
      const wf = engine.register({
        name: "Simple", description: "", version: "1.0.0", tags: [],
        steps: [{
          id: "step1", type: "navigate", description: "Go to page",
          params: { url: "https://example.com" },
          timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "abort",
        }],
      });
    ...
    it("should abort on step failure when onFailure is abort", async () => {
      const wf = engine.register({
        name: "Failing", description: "", version: "1.0.0", tags: [],
        steps: [
          {
            id: "step1", type: "navigate", description: "Step 1",
            params: {}, timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "abort",
          },
          {
            id: "step2", type: "click", description: "Step 2",
            params: {}, timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "abort",
          },
        ],
      });
    ...
    it("should skip failing steps when onFailure is skip", async () => {
      const wf = engine.register({
        name: "Skip", description: "", version: "1.0.0", tags: [],
        steps: [
          {
            id: "step1", type: "navigate", description: "Step 1",
            params: {}, timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "skip",
          },
          {
            id: "step2", type: "click", description: "Step 2",
            params: {}, timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "abort",
    ...
    it("should retry on failure when retryOnFailure is true", async () => {
      let attempts = 0;
      const wf = engine.register({
        name: "Retry", description: "", version: "1.0.0", tags: [],
        steps: [{
          id: "step1", type: "navigate", description: "Step 1",
          params: {}, timeoutMs: 5000,
          retryOnFailure: true, maxRetries: 2, onFailure: "abort",
        }],
      });
    ...
    it("should pass context between steps", async () => {
      const wf = engine.register({
        name: "Context", description: "", version: "1.0.0", tags: [],
        steps: [
          {
            id: "step1", type: "navigate", description: "Step 1",
            params: {}, timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "abort",
  ...
  describe("getExecution and listExecutions", () => {
    it("should track executions", async () => {
      const wf = engine.register({
        name: "Exec", description: "", version: "1.0.0", tags: [],
        steps: [{
          id: "step1", type: "navigate", description: "Step 1",
          params: {}, timeoutMs: 5000, retryOnFailure: false, maxRetries: 0, onFailure: "abort",
        }],

...
describe('DEBUG v2', () => {
  it('trace mixed', () => {
    ...
    console.log(
      'after console:',
      engine.getActiveIncidents().length,
      JSON.stringify(engine.getActiveIncidents().map((i) => i.title)),
    );
    ...
    console.log(
      'standalone exit:',
      engine2.getActiveIncidents().length,
      JSON.stringify(engine2.getActiveIncidents().map((i) => i.title)),
    );
  ...
  it('trace exit standalone', () => {
    ...
    console.log(
      'exit only:',
      engine.getActiveIncidents().length,
      JSON.stringify(engine.getActiveIncidents().map((i) => ({ title: i.title, tags: i.tags }))),
    );

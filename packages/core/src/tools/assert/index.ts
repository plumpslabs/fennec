...
export const browserAssert = createTool({
  ...
  inputSchema: z.object({
    ...
    selector: z.string().describe('Element selector (CSS / text= / role= / :has-text())'),
    expected: z
      .string()
      .optional()
      .describe('Expected text/value/attribute-value for *-equals assertions'),
    count: z.number().optional().describe('Expected element count for count-equals'),
    attribute: z.string().optional().describe('Attribute name for exists-with-attr'),
